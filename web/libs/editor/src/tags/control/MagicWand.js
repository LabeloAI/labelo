 ...
 * - Setting an environment variable when starting the Labelo server, either by starting up the
 ...
 * [Labelo storage guide](../guide/storage.html#Troubleshoot-CORS-and-access-problems) for more
 ...
 * use Labelo's signed URL support ([AWS](../guide/storage.html#Set-up-connection-in-the-Label-Studio-UI),
 ...
 *
 * If the image is on the same host as your Labelo instance, you can simply leave off the
 ...
 * @meta_description Customize Labelo with a Magic Wand tag to quickly click and drag to threshold flood fill image areas during image segmentation labeling for machine learning and data science projects.
