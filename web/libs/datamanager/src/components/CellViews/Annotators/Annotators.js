          ...
          >
            <Tooltip title={user.fullName || user.email}>
              <Userpic
                ...
                badge={{
                  bottomRight: review ? (
                    <Block name="userpic-badge" mod={{ [review]: true }} style={{borderRadius: 25, width: 7, height: 7}} title={review}>
                      {review === 'rejected' ? <LsCrossAlt/> : <LsCheckAlt/>}
                    </Block>
                  ): annotated && (<Block name="userpic-badge" mod={{ accepted: true }} style={{borderRadius: 25, width: 7, height: 7}} title="Annotated">
                    <LsCheckAlt/>
                  </Block>),
                }}
              />
