    ...
    get icon() {
      switch (self.alias) {
        ...
        case "total_annotations":
          return <LsAnnotation width="20" height="20" style={{ color: '#AADDFF' }}/>; //#0099FF
        case "cancelled_annotations":
          return <LsBanSquare width="20" height="20" style={{ color: '#F4AAAA' }}/>; //#DD0000
        case "total_predictions":
          return <LsSparkSquare width="20" height="20" style={{ color: '#CAA5FF' }}/>; //#944BFF
        case "reviews_accepted":
          return <LsThumbsUp width="20" height="20" style={{ color: '#B8DFAA' }}/>; //#2AA000
        case "reviews_rejected":
          return <LsThumbsDown width="20" height="20" style={{ color: '#F4AAAA' }}/>; //#DD0000
        case "ground_truth":
