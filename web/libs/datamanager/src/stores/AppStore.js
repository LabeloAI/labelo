...
export const AppStore = types
  .model("AppStore", {
    mode: types.optional(
      types.enumeration(["explorer", "labelstream", "labeling", "reviewstream", "reviewing"]),
      "explorer",
    ),
  ...
  .views((self) => ({
    ...
    get isReviewing() {
      return !!self.dataStore?.selected || self.isReviewStreamMode || self.mode === 'reviewing';
    },

    get isReviewStreamMode() {
      return self.mode === "reviewstream";
    },

    get isExplorerMode() {
      return self.mode === "explorer" || self.mode === 'labeling' || self.mode === 'reviewing';
    },
  ...
  .actions((self) => ({
    ...
    startReviewing(item, options = {}) {

      const nextAction = () => {

        self.SDK.setMode("reviewing");
