...
export const DataStore = (
  ...
  const model = types
    ...
    .actions((self) => ({
      ...
      fetch: flow(function* ({ id, query, pageNumber = null, reload = false, interaction, pageSize, search=false, project=false } = {}) {
        ...
        if(!search){
          ...
          data = yield root.apiCall('taskSearch', params, {}, { allowToCancel: root.SDK.type === 'DE' });
        }
