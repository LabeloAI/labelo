 ...
 * mode: "labelstream" | "explorer" | "reviewstream",
 * table: TableConfig,
...
const DEFAULT_TOOLBAR = "actions columns filters ordering review-button label-button loading-possum error-box search | refresh import-button export-button view-toggle";
...
export class DataManager {
  ...
  /** @type {"explorer" | "labelstream" | "reviewstream"} */
  mode = "explorer";
  ...
  /**
   *
   * @param {"explorer" | "labelstream" | "reviewstream"} mode
   */
  setMode(mode) {
