...
//       See the&nbsp;documentation to <a target="_blank" href="https://docs.labelo.ai/">import preannotated data</a>{" "}
//       or&nbsp;to <a target="_blank" href="https://docs.labelo.ai/">sync data from a&nbsp;database or&nbsp;cloud storage</a>.
//     </Modal.Footer>
//   );
// };
    ...
    <div className={importClass}>
      ...
      <header>
        <form className={importClass.elem("url-form") + " inline"} method="POST" onSubmit={onLoadURL}>
          ...
          <button type="submit" look="primary">Add URL</button>
        </form>
        <span>or</span>
          ...
          {!showList && (
            <label htmlFor="file-input">
              <div className={dropzoneClass.elem("content")}>
                <header style={{paddingTop: 20}}>Drag & drop files here<br/>or click to upload</header>
